...
export default function CompanyTransactionsScreen({ navigation }) {
                ...
                <SafeAreaView style={styles.safeArea}>
                    ...
                    <Animated.View style={[styles.header, { opacity: fadeAnim }]}>
                        ...
                        <View style={styles.headerContent}>
                            ...
                            <Text style={styles.headerSubtitle}>{userData?.companyName || 'Company'} Activity</Text>
                        </View>
                        <TouchableOpacity
                            style={styles.addButton}
                            onPress={() => navigation.navigate('AddCompanyTransaction')}
                        >
                        ...
                        <Animated.View style={[styles.summaryCard, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
                            ...
                            <View style={styles.summaryRow}>
                                <View style={styles.summaryItem}>
                                    ...
                                    <Text style={styles.summaryValue}>{formatCurrency(transactionSummary.totalRevenue)}</Text>
                                </View>
                                ...
                                <View style={styles.summaryItem}>
                                    ...
                                    <Text style={styles.summaryValue}>{formatCurrency(transactionSummary.netProfit)}</Text>
                                </View>
                            </View>
                        </Animated.View>
